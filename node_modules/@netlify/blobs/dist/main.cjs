...
var Store = class _Store {
  ...
  async get(key, options) {
    return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.get", async (span) => {
  ...
  async getMetadata(key, { consistency } = {}) {
    return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.getMetadata", async (span) => {
      span?.setAttributes({
        "blobs.store": this.name,
        "blobs.key": key,
        "blobs.method": "HEAD",
  ...
  async getWithMetadata(key, options) {
    return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.getWithMetadata", async (span) => {
  ...
  list(options = {}) {
    return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.list", (span) => {
      span?.setAttributes({
        "blobs.store": this.name,
        "blobs.method": "GET",
  ...
  async set(key, data, options = {}) {
    return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.set", async (span) => {
      span?.setAttributes({
        "blobs.store": this.name,
        "blobs.key": key,
        "blobs.method": "PUT",
  ...
  async setJSON(key, data, options = {}) {
    return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.setJSON", async (span) => {
      span?.setAttributes({
        "blobs.store": this.name,
        "blobs.key": key,
        "blobs.method": "PUT",
  ...
  getListIterator(options) {
    ...
    return {
      [Symbol.asyncIterator]() {
        ...
        return {
          async next() {
            return (0, import_otel.withActiveSpan)((0, import_otel.getTracer)(), "blobs.list.next", async (span) => {
              span?.setAttributes({
